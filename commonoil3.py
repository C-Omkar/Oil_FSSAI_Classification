...
if os.path.exists("potential_oil3_compositions.xlsx"):
    with pd.ExcelWriter("potential_oil3_compositions.xlsx", mode="a", engine="openpyxl", if_sheet_exists="replace") as writer:
