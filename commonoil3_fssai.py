...
def check_oil(v, w, x, o1, o2, o3):
    contain = True
    ctr = 0
    while(contain):
        if(oil_bounds[o1][ctr][0]*v + oil_bounds[o2][ctr][0]*w + oil_bounds[o3][ctr][0]*x <= percentages[ctr] and percentages[ctr] <= oil_bounds[o1][ctr][1]*v + oil_bounds[o2][ctr][1]*w + oil_bounds[o3][ctr][1]*x):
            ctr +=1
            if ctr == 21:
                return True
        else:
        ...
        for k in range(j, 19):
                    ...
                    if len(temp) == len(temp2):
                        ...
                        for v in checkv:
                            ...
                            for w in checkw:
                                        if check_oil(v, w, 1-v-w, o1, o2, o3):
                                            solutions.append([o1, round(100*v, 2), o2, round(100*w, 2), o3, round(100*(1-v-w), 2)])
...
if os.path.exists("potential_oil3_compositions_fssai.xlsx"):
    with pd.ExcelWriter("potential_oil3_compositions_fssai.xlsx", mode="a", engine="openpyxl", if_sheet_exists="replace") as writer:
